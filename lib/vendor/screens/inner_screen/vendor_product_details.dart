...
class VendorProductDetail extends ConsumerStatefulWidget {
  final dynamic productData;

  const VendorProductDetail({Key? key, this.productData}) : super(key: key);

  @override
  _VendorProductDetailState createState() => _VendorProductDetailState();
}

class _VendorProductDetailState extends ConsumerState<VendorProductDetail> {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          '\Egp${widget.productData['discountPrice'].toStringAsFixed(2)}',
      ...
      bottomSheet: Padding(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            clipBehavior: Clip.hardEdge,
            decoration: BoxDecoration(
              color: isInCart ? Colors.grey : const Color.fromARGB(255, 225, 155, 16),
