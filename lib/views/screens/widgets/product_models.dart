...
class _ProductModelState extends ConsumerState<ProductModel> {
  ...
  Widget build(BuildContext context) {
    ...
    // Add the following print statements for debugging
    print('Product ID: ${widget.productData['productId']}');
    print('Cart Items: ${ref.watch(cartProvider)}');
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                ...
                top: 207,
                child: Text(
                  '\Egp' + widget.productData['discountPrice'].toString(),
                  style: TextStyle(
                    color: Color(0xFF1E3354),
                    fontSize: 10,
                    fontWeight: FontWeight.w600,
              ...
              Positioned(
                ...
                top: 210,
                child: Text(
                  '\ Egp' + widget.productData['price'].toString(),
                  style: TextStyle(
